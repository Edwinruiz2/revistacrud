...
<label for="validationTooltip01" class="fw-bold">Nombre:</label>
...
<label for="validationTooltip02" class="fw-bold">isbn:</label>
...
<label for="validationServer03" class="fw-bold">Fecha:</label>
...
<label for="validationServer04" class="fw-bold">Tipo de revista:</label>
...
<label for="validationServer05" class="fw-bold">Director de la revista:</label>
